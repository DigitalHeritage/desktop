...
<div>
  <section class="hero is-primary">
    <div class="hero-body">
      <div class="container">
        ...
        <h2 class="subtitle">
          DigitalHeritage is brought to you by <a href="https://www.ideesculture.com">IdéesCulture</a>.
        </h2>
      </div>
    </div>
  <nav
  ...
  <div id="about-body">
    <div class="container" style="padding-top:40px;">
      ...
      <h1 class="is-size-1 has-text-link">Brainjuicing</h1><h2 class="is-size-3 has-text-grey-dark">Transforming your lemon hat to pure lemon-aid from 2012.</h2>
